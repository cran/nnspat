...
#' The \code{nnspat} functions can be grouped as 
#' Auxiliary Functions, 
#' NNCT Functions, 
#' SCCT Functions, 
#' RCT Functions,
...
#' Contains the auxiliary functions used in NN methods, such as indices of NNs, number of shared NNs, 
#' Q, R and T values, and so on. 
#' In all these functions the data sets are either matrices or data frames.
#'
#' @section NNCT Functions:
#' Contains the functions for testing segregation/association using the NNCT. 
...
#' Contains the functions used for testing species correspondence using the NNCT. 
...
#' Contains the functions for testing reflexivity using the reflexivity contingency table (RCT). 
#' The types are NN 
...
#' and \eqn{Q}-symmetry contingency table. The types are NN 
...
#' Contains the functions for generating and visualization of spatial patterns of segregation, 
